					...
					<div class="page-title edit-project-title">
						...
						<div id="edit-project" class="settings-section">
							...
							<div class="section-item description">
								<label for="description">Description</label> <span class="help">e.g.
									"Any register user can log in"</span>
								<div class="input-wrap">
						...
						<div id="edit-project" class="settings-section">
							<div class="section-item title">
								<h1>Scenario</h1>
								<label for="title">Title</label> <span class="help">e.g.
									"Login with valid credentials"</span>
								<div class="input-wrap">
									<input name="scenarios[0].title"
										value="${feature.scenarios[0].title}" type="text" id="title">
								</div>
							</div>
									...
									<div id="step0" class="clonedInput settings-section">
										...
										<div class="section-item step">
											<select name="scenarios[0].steps[0].type">
												<option ${step.type == "Given" ? "selected" : ''}
													value="Given">Given</option>
												<option ${step.type == "And" ? "selected" : ''} value="And">And</option>
												<option ${step.type == "When" ? "selected" : ''}
													value="When">When</option>
												<option ${step.type == "Then" ? "selected" : ''}
													value="Then">Then</option>
											</select> <span class="help">e.g. "I am a registered user"</span>
											<div class="input-wrap">
												<input type="text" value="${step.title}"
													name="scenarios[0].steps[0].title" id="step">
											</div>
											<div class="input-wrap">
												<textarea rows="4" cols="50"
													name="scenarios[0].steps[0].code">
                                        </textarea>
											</div>
										</div>
										<div class="actions">
											<button class="btn clone save-project create-project">Add
												Step</button>
											<button class="btn remove save-project create-project danger">Remove
												Step</button>
										</div>
										<br>
									</div>
