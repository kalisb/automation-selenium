			...
			<section class="content">
				<div class="page-title">
					...
					<div class="pull-right">
						<a href="<c:url value="/projects/edit/${project.id}/features" />"
							id="new-project-main" class="btn add-btn new-project">New
							Feature</a>
					</div>
				</div>
				...
				<c:if test="${features.size() == 0}">
					<div id="no-projects">
						...
						<a href="<c:url value="/projects/edit/${project.id}/features" />"
							class="btn add-btn new-project">New Feature</a>
					</div>
				</c:if>
						...
						<div id="project-255217" class="project private">
							<a href="#">
								<div class="project-thumb no-thumbnail">
									<img src="<c:url value="/resources/img/feature.png" />" alt=""
										class="transparent">
								</div>
							</a>
							<div>
								<a style="display: inline-block;"
									href="<c:url value="/projects/edit/${project.id}/features/${feature.id}" />">${feature.title}</a>
								<a class='confirm' id=${feature.id
									} style="display: inline-block; float: right;" href="#"><i class="fa fa-trash" aria-hidden="true"></i></a>
							</div>
						</div>
					</c:forEach>
				</div>
