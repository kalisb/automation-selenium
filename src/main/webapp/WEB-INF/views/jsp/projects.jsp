		...
		<div class="main">
		    ...
		    <section class="sidebar">
                ...
                <ul class="nav main-nav">
                    <li><a href="<c:url value="/projects/" />" class="projects current">Projects</a></li>
                </ul>
            </section>
            <section class="content">
                <div class="page-title">
                    ...
                    <div class="pull-right">
			            <a href="<c:url value="/projects/new" />" id="new-project-main" class="btn add-btn new-project">New Project</a>
		            </div>
	            </div>

	            <div id="projects-alert" class="alert" role="alert">
		            <a href="#" class="close">dismiss <span class="cross">x</span></a>
		            Quick tip: You can re-order projects by dragging and dropping them into place.
	            </div>
	                    ...
	                    <div id="project-255217" class="project private">
	                        <a href="#">
                		        <div class="project-thumb no-thumbnail">
                			        <img src="<c:url value="/resources/img/project.jpg" />" alt="" class="transparent">
                			    </div>
                		    </a>
                		    <a href="<c:url value="/projects/edit/${project.id}" />" class="project-title">${project.title}</a>
                ...
                <c:if test = "${projects.size() == 0}">
                    <div id="no-projects">
                        ...
                        <a href="<c:url value="/projects/new" />" class="btn add-btn new-project">New Project</a>
                    </div>
	            </c:if>
                ...
                <div id="rename-project-modal" class="modal">
                    ...
                    <p>Rename this project by entering a new title below. Any changes will take effect immediately.</p>
