...
import static web.technology.selenium.framework.config.webdriver.SystemArchitecture.*;

public class FileRepository {

	 public static DriverMap buildDownloadableFileRepository(NodeList nodesFound, String browser, boolean useThirtyTwoBitBinaries, boolean useSixtyFourBitBinaries, boolean useArmBinaries) throws JAXBException {
